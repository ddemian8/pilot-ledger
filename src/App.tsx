    ...
    <main className="app-shell">
      ...
      <section className="content-area">
        ...
        <div className={`content-wrap page-${activePage}`} id="dashboard">
          ...
          {activePage === 'transactions' && <div className="page-header transactions-header"><div><p className="eyebrow">TOATE MIȘCĂRILE</p><h1>Tranzacții</h1><p className="muted">Caută, filtrează și gestionează istoricul tău.</p></div><button className="save-button page-add-button" onClick={() => openEntry('expense')}>+ Adaugă tranzacție</button></div>}
